		...
		<div id="content">
			<div class="row">
				<div class="col-sm-9">
					...
					<div class="row">
						<div class="col-sm-4" >
							<img src="image/image/<?php echo $row['image'] ?>" alt="no_picture">
						</div>
...
?>
                        ...
                        <?php
$fine_comment = "select u.fullname as name, c.comment as comment from users u inner join comments c on u.id_user=c.id_user where c.product_id= '$id' order by c.id desc ";
				...
				<div class="col-sm-3 aside">
					<div class="widget">
						...
						<div class="widget-body">
                            ...
                            <?php
								$sql4="select * from products order by numbersold desc limit 4";
					...
					echo '<img src="image/image/'.$row4['image'].'" />';
					?></a>
					...
					echo '<img src="image/image/'.$row3['image'].'" />';
					?></a>
									<div class="media-body">
										<?php echo $row3['title'] ?>
